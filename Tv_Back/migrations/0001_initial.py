# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-06 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episodes', models.IntegerField(blank=True, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Tv_Back.CategorySerie')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
